...
#define configCPU_CLOCK_HZ				( CORE_CLOCK )                   // {1} inherit the CPU clock from the uTasker configuration
#define configTICK_RATE_HZ				( ( TickType_t ) (1000 / (_TICK_RESOLUTION / 1000)) ) // inherit the us TICK value from uTasker
