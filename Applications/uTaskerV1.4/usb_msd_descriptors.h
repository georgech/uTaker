...
*/
    ...
    #define USB_PRODUCT_RELEASE_NUMBER      0x0100                       // V1.0 (binary coded decimal)
        ...
        #define USB_MSD_IN_ENDPOINT_NUMBER  0x01
    #else
        #define NUMBER_OF_MSD_ENDPOINTS     (2)                          // uses 2 endpoints (1 IN and 1 OUT) in addition to the default control endpoint 0
        #define USB_MSD_IN_ENDPOINT_NUMBER  0x02
    #endif

    #define USB_MSD_INTERFACE_COUNT           1
    #define USB_MOUSE_IN_ENDPOINT_NUMBER (USB_MSD_IN_ENDPOINT_NUMBER + 1)
    #if defined USE_USB_HID_MOUSE                                        // MSD with HID mouse
        #define USB_MOUSE_INTERFACE_NUMBER    (USB_HID_MOUSE_INTERFACE_COUNT)
    ...
    #define USB_KEYBOARD_IN_ENDPOINT_NUMBER (USB_MOUSE_IN_ENDPOINT_NUMBER + USB_HID_MOUSE_ENDPOINT_COUNT)
    #if defined USE_USB_HID_KEYBOARD                                     // MSD with HID keyboard
        #define USB_KEYBOARD_INTERFACE_NUMBER (USB_MSD_INTERFACE_COUNT + USB_HID_MOUSE_INTERFACE_COUNT)
    ...
    #endif
    #if defined USE_USB_HID_RAW                                          // MSD with HID RAW device
        #define USB_HID_RAW_INTERFACE_NUMBER (USB_MSD_INTERFACE_COUNT + USB_HID_MOUSE_INTERFACE_COUNT + USB_HID_KB_INTERFACE_COUNT)
        ...
        #define USB_HID_RAW_OUT_ENDPOINT_NUMBER     (USB_HID_RAW_IN_ENDPOINT_NUMBER + 1)
    ...
    #endif
    #if defined USE_USB_AUDIO                                            // MSD with audio class
        #define USB_AUDIO_INTERFACE_NUMBER (USB_MSD_INTERFACE_COUNT + USB_HID_MOUSE_INTERFACE_COUNT + USB_HID_KB_INTERFACE_COUNT + USB_HID_RAW_INTERFACE_COUNT)
    ...
    #define USB_INTERFACE_COUNT              (USB_MSD_INTERFACE_COUNT + USB_HID_MOUSE_INTERFACE_COUNT + USB_HID_KB_INTERFACE_COUNT + USB_HID_RAW_INTERFACE_COUNT + USB_AUDIO_INTERFACE_COUNT) // configuration number (1 interfaces for each available MSD, mouse and keyboard)
    #define NUMBER_OF_ENDPOINTS              (NUMBER_OF_MSD_ENDPOINTS + USB_HID_MOUSE_ENDPOINT_COUNT + USB_HID_KB_ENDPOINT_COUNT + USB_HID_RAW_ENDPOINT_COUNT + USB_AUDIO_ENDPOINT_COUNT)

    #if defined _M5223X || defined _KINETIS
        #define USB_VENDOR_ID               0x0425                       // MOTOROLA vendor ID {19}
        #define USB_PRODUCT_ID              (0xff4f + USB_HID_MOUSE_INTERFACE_COUNT + (USB_HID_KB_INTERFACE_COUNT * 2) + (USB_HID_RAW_INTERFACE_COUNT * 3) + (USB_AUDIO_INTERFACE_COUNT * 4)) // unofficial test value
...
typedef struct _PACK stUSB_CONFIGURATION_DESCRIPTOR_COLLECTION
{
    ...
    USB_INTERFACE_DESCRIPTOR                   interface_desc_0;         // MSD interface descriptor
    ...
    USB_INTERFACE_DESCRIPTOR                   interface_desc_mouse;     // mouse interface descriptor
    ...
    USB_INTERFACE_DESCRIPTOR                   interface_desc_keyboard;  // keyboard interface descriptor
    ...
    USB_INTERFACE_DESCRIPTOR                   interface_desc_raw;       // raw HID interface descriptor
...
static const USB_CONFIGURATION_DESCRIPTOR_COLLECTION config_descriptor = {
    ...
    DESCRIPTOR_TYPE_INTERFACE_LENGTH,                                    // length (0x09)
    DESCRIPTOR_TYPE_INTERFACE,                                           // 0x04
    USB_MOUSE_INTERFACE_NUMBER,                                          // number of interface
    0,                                                                   // alternative setting 0
    ...
    DESCRIPTOR_TYPE_INTERFACE_LENGTH,                                    // length (0x09)
    DESCRIPTOR_TYPE_INTERFACE,                                           // 0x04
    USB_HID_RAW_INTERFACE_NUMBER,                                        // interface number
    0,                                                                   // alternative setting 0
    2,                                                                   // number of endpoints in addition to EP0
    USB_CLASS_HID,                                                       // interface class (0x03)
