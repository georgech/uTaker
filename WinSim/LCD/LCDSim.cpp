...
extern void fnRedrawDisplay(void);
    ...
    //                                      [ page addr.  ][ Col. addr.]
    #if defined GLCD_COLOR || defined TFT_GLCD_MODE || defined NOKIA_GLCD_MODE || defined CGLCD_GLCD_MODE || defined KITRONIX_GLCD_MODE || defined TFT2N0369_GLCD_MODE || defined ST7789S_GLCD_MODE || defined MB785_GLCD_MODE || defined SLCD_FILE // {7}{8}{13}
    ...
    #if defined GLCD_COLOR || defined NOKIA_GLCD_MODE || defined CGLCD_GLCD_MODE || defined KITRONIX_GLCD_MODE || defined TFT2N0369_GLCD_MODE || defined ST7789S_GLCD_MODE || defined MB785_GLCD_MODE // {8}{13}
...
extern int fnInitLCD(RECT &rt, int iHeight, int iWidth)
{
    ...
    #if defined GLCD_COLOR || defined TFT_GLCD_MODE || defined NOKIA_GLCD_MODE || defined CGLCD_GLCD_MODE || defined KITRONIX_GLCD_MODE || defined TFT2N0369_GLCD_MODE || defined ST7789S_GLCD_MODE || defined MB785_GLCD_MODE || defined SLCD_FILE // {13}
...
static void DrawLcdLine(HWND hwnd)
{
    ...
    #if defined GLCD_COLOR || defined TFT_GLCD_MODE || defined NOKIA_GLCD_MODE || defined CGLCD_GLCD_MODE || defined KITRONIX_GLCD_MODE || defined TFT2N0369_GLCD_MODE || defined ST7789S_GLCD_MODE // {7}{8}
...
#if (defined SUPPORT_GLCD || defined SUPPORT_TFT || defined TFT_GLCD_MODE || defined GLCD_COLOR || defined KITRONIX_GLCD_MODE || defined TFT2N0369_GLCD_MODE || defined ST7789S_GLCD_MODE) && !defined OLED_GLCD_MODE || defined CGLCD_GLCD_MODE // {6}{7}
    #if defined GLCD_COLOR || defined TFT_GLCD_MODE || defined NOKIA_GLCD_MODE || defined CGLCD_GLCD_MODE || defined KITRONIX_GLCD_MODE || defined TFT2N0369_GLCD_MODE || defined ST7789S_GLCD_MODE // {7}{8}
    if (pPixels != 0) {                                                  // {19}
    ...
    for (i = 0; i < GLCD_Y; i++) {                                       // for each line
        ...
        for (j = 0; j < GLCD_X; j++) {                                   // for each pixel in line
            ...
            if (ucPixelFormat == PIXEL_16_BIT) {
                ...
                #if defined _HX8347 || defined KITRONIX_GLCD_MODE || defined TFT2N0369_GLCD_MODE || defined ST7789S_GLCD_MODE || defined MB785_GLCD_MODE // {15}
...
static void fnWriteDisplay(unsigned long ulByte)
{
    ...
    #endif
    #if defined GLCD_COLOR || defined TFT_GLCD_MODE || defined NOKIA_GLCD_MODE || defined CGLCD_GLCD_MODE || defined KITRONIX_GLCD_MODE || defined TFT2N0369_GLCD_MODE || defined ST7789S_GLCD_MODE || defined MB785_GLCD_MODE // {7}{8}{13}
    ...
    #if defined _HX8347 || defined KITRONIX_GLCD_MODE || defined TFT2N0369_GLCD_MODE || defined ST7789S_GLCD_MODE || defined MB785_GLCD_MODE
                dwPixelColor = ((dwPixelColor << 16) | (dwPixelColor & 0x0000ff00) | (dwPixelColor >> 16));
    #endif
    #if defined BIG_PIXEL
...
static void GraphicLCDCommand(bool bRS, unsigned long ulByte)
{
    ...
    if (bRS == 0) {                                                      // index register write
        ...
        case 0x46:                                                       // horizontal RAM address end position
            ...
            break;
            #if defined TFT2N0369_GLCD_MODE || defined ST7789S_GLCD_MODE
        ...
        #endif
        #if !defined NOKIA_GLCD_MODE
            #if defined _HX8347 || defined KITRONIX_GLCD_MODE || defined TFT2N0369_GLCD_MODE || defined ST7789S_GLCD_MODE
        ...
        case 0x2c:                                                       // write to display memory
            ...
            #endif
            break;
            #if !defined KITRONIX_GLCD_MODE && !defined TFT2N0369_GLCD_MODE && !defined ST7789S_GLCD_MODE
...
{
    #if defined GLCD_COLOR || defined CGLCD_GLCD_MODE || defined KITRONIX_GLCD_MODE || defined TFT2N0369_GLCD_MODE || defined ST7789S_GLCD_MODE // {8}
    static int iColor = 0;
    unsigned long ulNewPixel;
