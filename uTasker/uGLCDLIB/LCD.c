/***********************************************************************
    ...
    *********************************************************************
    ...
    11.03.2019 Add AVAGO_HCMS_CHAR_LCD mode
...
#if defined AVAGO_HCMS_CHAR_LCD
    static unsigned char ucPixels[LCD_CHARACTERS * BYTES_PER_HCMS_CHARACTER] = { 0 };
...
static unsigned char fnReadDisplay(LCD_CONTROL_PORT_SIZE rs)
{
#if !defined AVAGO_HCMS_CHAR_LCD || defined _WINDOWS
    #if defined LCD_BUS_4BIT
...
#elif !defined AVAGO_HCMS_CHAR_LCD || defined _WINDOWS
