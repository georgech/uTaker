...
#define MODBUS_ENCAPSUL_INTERFACE_TRANSPORT  0x2b
    ...
    #define MODBUS_ENCAP_READ_DEVICE_IDENTIFIER  0x0e
        #define MODBUS_ENCAP_READ_DEVICE_IDENTIFIER_CODE_BASIC    0x01
        #define MODBUS_ENCAP_READ_DEVICE_IDENTIFIER_CODE_REGULAR  0x02
        #define MODBUS_ENCAP_READ_DEVICE_IDENTIFIER_CODE_EXTENDED 0x03
        #define MODBUS_ENCAP_READ_DEVICE_IDENTIFIER_CODE_SPECIFIC 0x04

        #define DEVICE_ID_OBJECT_NAME_VENDOR_NAME                 0x00
        #define DEVICE_ID_OBJECT_NAME_PRODUCT_CODE                0x01
        #define DEVICE_ID_OBJECT_NAME_MAJOR_MONOR_REVISION        0x02
        #define DEVICE_ID_OBJECT_NAME_VENDOR_URL                  0x03
        #define DEVICE_ID_OBJECT_NAME_PRODUCT_NAME                0x04
        #define DEVICE_ID_OBJECT_NAME_MODEL_NAME                  0x05
        #define DEVICE_ID_OBJECT_NAME_USER_APPLICATION_NAME       0x06
        #define DEVICE_ID_OBJECT_NAME_PRIVATE_START               0x80
