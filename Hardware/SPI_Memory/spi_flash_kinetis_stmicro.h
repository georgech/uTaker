...
#if defined _WINDOWS
        fnSimSPI_Flash(STM25PXXX_WRITE, (unsigned char)SPI_TX_BYTE);     // simulate the SPI FLASH device
#endif
...
#if defined _WINDOWS
            SPI_RX_BYTE = fnSimSPI_Flash(STM25PXXX_READ, (unsigned char)SPI_TX_BYTE); // simulate the SPI FLASH device
#endif
