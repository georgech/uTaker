...
extern void fnCheckEthLinkState(void)
{
    ...
    #endif
            break;
    #if (defined _DP83849I/* || defined _KSZ8081RNA*/) && defined INTERRUPT_TASK_PHY // {52}{84}{100}
...
extern int fnConfigEthernet(ETHTABLE *pars)
{
    ...
    #if !defined _WINDOWS
    while ((ECR & RESET_FEC) != 0) {}                                    // short wait until reset is complete
    #endif
    #if defined LAN_REPORT_ACTIVITY || defined LAN_TX_FPU_WORKAROUND     // {12}
...
#if 1
    fnEnterInterrupt(irq_ETH_ID, PRIORITY_EMAC, _fec_rx_frame_isr);
#else
