...
static const char *cPinNumber[PORTS_AVAILABLE][PORT_WIDTH] = {           // 81 pin MAPGBA / 80 pin LQPF
    ...
    // PORT E (0..31)
    { "1/E4 {PE.0/ADC1_SE4a/SPI1_PCS1/UART1_TX/SDHC0_D1/I2C1_SDA}", "2/E3 {PE.1/ADC1_SE5a/SPI1_SOUT/UART1_RX/SDHC0_D0/I2C1_SCL}", "3/E2 {PE.2/ADC1_SE6a/SPI1_SCK/UART1_CTS_b/SDHC0_DCLK}", "4/F4 {PE.3/ADC1_SE7a/SPI1_SIN/UART1_RTS_b/SDHC0_CMD}", "5/H7 {PE.4/SPI1_PCS0/UART3_TX/SDHC0_D3}", "6/G4 {PE.5/SPI1_PCS2/UART3_RX/SDHC0_D2}", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "9/F1 {PE.16/ADC0_SE4a//SPI0_PCS0/UART2_TX/FTM_CLKIN0/FTM0_FLT3}", "10/F2 {PE.17/ADC0_SE5a/PTE17/SPI0_SCK/UART2_RX/FTM_CLKIN1/LPT0_ALT3}", "11/G1 {PE.18/ADC0_SE6a/SPI0_SOUT/UART2_CTS_b/I2C0_SDA}", "12/G2 {PE.19/ADC0_SE7a/SPI0_SIN/UART2_RTS_b/I2C_SCL}", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA"}
};
...
static const char *cPinNumber[PORTS_AVAILABLE][PORT_WIDTH] = {           // 100 pin LQPF
    ...
    // PORT E (0..31)
    { "1 {PE.0/ADC1_SE4a/SPI1_PCS1/UART1_TX/SDHC0_D1/I2C1_SDA}", "2 {PE.1/ADC1_SE5a/SPI1_SOUT/UART1_RX/SDHC0_D0/I2C1_SCL}", "3 {PE.2/ADC1_SE6a/SPI1_SCK/UART1_CTS_b/SDHC0_DCLK}", "4 {PE.3/ADC1_SE7a/SPI1_SIN/UART1_RTS_b/SDHC0_CMD}", "5 {PE.4/SPI1_PCS0/UART3_TX/SDHC0_D3}", "6 {PE.5/SPI1_PCS2/UART3_RX/SDHC0_D2}", "7 {PE.6/SPI1_PCS3/UART3_CTS_b/I2S0_MCLK/I2S0_CLKIN}", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "16 {PE.16/ADC0_SE4a//SPI0_PCS0/UART2_TX/FTM_CLKIN0/FTM0_FLT3}", "11 {PE.17/ADC0_SE5a/PTE17/SPI0_SCK/UART2_RX/FTM_CLKIN1/LPT0_ALT3}", "12 {PE.18/ADC0_SE6a/SPI0_SOUT/UART2_CTS_b/I2C0_SDA}", "13 {PE.19/ADC0_SE7a/SPI0_SIN/UART2_RTS_b/I2C_SCL}", "NA", "NA", "NA", "NA", "31 {PE.24/ADC0_SE17/CAN1_TX/UART4_TX/EWM_OUT_b}", "32 {PE.25/ADC0_SE18/CAN1_RX/UART4_RX/EWM_IN}", "33 {PE.26/UART4_CTS_b/RTC_CLKOUT}", "NA", "NA", "NA", "NA", "NA"}
};
...
static const char *cPinNumber[PORTS_AVAILABLE][PORT_WIDTH] = {           // 121 pin MAPBGA
    ...
    // PORT E (0..31)
    { "E4 {PE.0/ADC1_SE4a/SPI1_PCS1/UART1_TX/SDHC0_D1/I2C1_SDA}", "E3 {PE.1/ADC1_SE5a/SPI1_SOUT/UART1_RX/SDHC0_D0/I2C1_SCL}", "E2 {PE.2/ADC1_SE6a/SPI1_SCK/UART1_CTS_b/SDHC0_DCLK}", "F4 {PE.3/ADC1_SE7a/SPI1_SIN/UART1_RTS_b/SDHC0_CMD}", "H7 {PE.4/SPI1_PCS0/UART3_TX/SDHC0_D3}", "G4 {PE.5/SPI1_PCS2/UART3_RX/SDHC0_D2}", "F3 {PE.6/SPI1_PCS3/UART3_CTS_b/I2S0_MCLK/I2S0_CLKIN}", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "F1 {PE.16/ADC0_SE4a//SPI0_PCS0/UART2_TX/FTM_CLKIN0/FTM0_FLT3}", "F2 {PE.17/ADC0_SE5a/PTE17/SPI0_SCK/UART2_RX/FTM_CLKIN1/LPT0_ALT3}", "G1 {PE.18/ADC0_SE6a/SPI0_SOUT/UART2_CTS_b/I2C0_SDA}", "G2 {PE.19/ADC0_SE7a/SPI0_SIN/UART2_RTS_b/I2C_SCL}", "NA", "NA", "NA", "NA", "H5 {PE.24/ADC0_SE17/CAN1_TX/UART4_TX/EWM_OUT_b}", "J5 {PE.25/ADC0_SE18/CAN1_RX/UART4_RX/EWM_IN}", "H6 {PE.26/UART4_CTS_b/RTC_CLKOUT}", "NA", "NA", "NA", "NA", "NA"}
};
#else
static const char *cPinNumber[PORTS_AVAILABLE][PORT_WIDTH] = {           // 144 pin LQFP/MAPBGA
    ...
    // PORT D (0..31)
    { "127/A5 {PD.0/SPI0_PCS0/UART2_RTS_b}", "128/D4 {PD.1/ADC0_SE5b/SPI0_SCK/UART2_CTS_b}", "129/C4 {PD.2/SPI0_SOUT/UART2_RX}", "130/B4 {PD.3/SPI0_SIN/UART2_TX}", "131/A4 {PD.4/SPI0_PCS1/UART0_RTS_b/FTM0_CH4/EWM_IN}", "132/A3 {PD.5/ADC0_SE6b/SPI0_PCS2/UART0_CTS_b/FTM0_CH5/EWM_OUT_b}", "133/A2 {PD.6/ADC0_SE7b/SPI0_PCS3/UART0_RX/FTM0_CH6/FTM0_FLT0}", "136/A1 {PD.7/CMT_IRO/UART0_TX/FTM0_CH7/FTM0_FLT1}", "NA", "NA", "139/B3 {PD.10/UART5_RTS_b/FB_AD9}", "140/B2 {PD.11/SPI2_PCS0/UART5_CTS_b/SDHC0_CLKIN/FB_AD8}", "141/B1 {PD.12/SPI2_SCK/SDHC0_D4/FB_AD7}", "142/C3 {PD.13/SPI2_SOUT/SDHC0_D5/FB_AD6}", "143/C2 {PD.14/SPI2_SIN/SDHC0_D6/FB_AD5}", "144/C1 {PD.15/SPI2_PCS1/SDHC0_D7/FB_RW_b}", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA", "NA"},
    // PORT E (0..31)
    { "1/D3 {PE.0/ADC1_SE4a/SPI1_PCS1/UART1_TX/SDHC0_D1/FB_AD27/I2C1_SDA}", "2/D2 {PE.1/ADC1_SE5a/SPI1_SOUT/UART1_RX/SDHC0_D0/FB_AD26/I2C1_SCL}", "3/D1 {PE.2/ADC1_SE6a/SPI1_SCK/UART1_CTS_b/SDHC0_DCLK/FB_AD25}", "4/E4 {PE.3/ADC1_SE7a/SPI1_SIN/UART1_RTS_b/SDHC0_CMD/FB_AD24}", "7/E3 {PE.4/SPI1_PCS0/UART3_TX/SDHC0_D3/FB_CS3_b/FB_BE7_0_BLS31_24b/FB_TA_b}", "8/E2 {PE.5/SPI1_PCS2/UART3_RX/SDHC0_D2/FB_TBST_b/FB_CS2_b/FB_BE15_8_BLS23_16_b}", "9/E1 {PE.6/SPI1_PCS3/UART3_CTS_b/I2S0_MCLK/FB_ALE/FB_CS1_b/FB_TS_b/I2S0_CLKIN}", "10/F4 {PE.7/UART3_RTS_b/I2S0_RXD/FB_CS0_b}", "11/F3 {PE.8/UART5_TX/I2S0_RX_FS/FB_AD4}", "12/F2 {PE.9/UART5_RX/I2S0_RX_BCLK/FB_AD3}", "13/F1 {PE.10/UART5_CTS_b/I2S0_TXD/FB_AD2}", "14/G4 {PE.11/UART5_RTS_b/I2S0_TX_FS/FB_AD1}", "15/G3 {PE.12/I2S0_TX_BCLK/FB_AD0}", "NA", "NA", "NA", "18/H1 {PE.16/ADC0_SE4a//SPI0_PCS0/UART2_TX/FTM_CLKIN0/FTM0_FLT3}", "19/H2 {PE.17/ADC0_SE5a/PTE17/SPI0_SCK/UART2_RX/FTM_CLKIN1/LPT0_ALT3}", "20/G1 {PE.18/ADC0_SE6a/SPI0_SOUT/UART2_CTS_b/I2C0_SDA}", "21/G2 {PE.19/ADC0_SE7a/SPI0_SIN/UART2_RTS_b/I2C_SCL}", "NA", "NA", "NA", "NA", "45/M4 {PE.24/ADC0_SE17/CAN1_TX/UART4_TX/EWM_OUT_b}", "46/K5 {PE.25/ADC0_SE18/CAN1_RX/UART4_RX/FB_AD23/EWM_IN}", "47/K4 {PE.26/UART4_CTS_b/FB_AD22/RTC_CLKOUT}", "48/J4 {PE.27/UART4_RTS_b/FB_AD21}", "49/H4 {PE.28/FB_AD20}", "NA", "NA", "NA"}
};
#endif
...
static const char *cPer[PORTS_AVAILABLE][PORT_WIDTH][8] = {              // 100 pin LQFP
    ...
    },
    {
        ...
        {  "D",            "PTE26", "?",         "UART4_CTS_b","?",           "?",         "RTC_CLKOUT","?"                },
        {  "?",            "?",     "?",         "?",          "?",           "?",         "?",        "?"                 },
        {  "?",            "?",     "?",         "?",          "?",           "?",         "?",        "?"                 },
        {  "?",            "?",     "?",         "?",          "?",           "?",         "?",        "?"                 },
        {  "?",            "?",     "?",         "?",          "?",           "?",         "?",        "?"                 },
...
static const char *cPer[PORTS_AVAILABLE][PORT_WIDTH][8] = {              // 121 pin MAPBGA
    ...
    },
    {
        ...
        {  "?",            "?",     "?",         "?",          "?",           "?",         "?",        "?"                 },
        {  "?",            "PTD10", "?",         "UART5_RTS_b","?",           "?",         "?",        "?"                 },
        {  "?",            "PTD11", "SPI2_PCS0", "UART5_CTS_b","SDHC0_CLKIN", "?",         "?",        "?"                 },
        {  "?",            "PTD12", "SPI2_SCK",  "?",          "SDHC0_D4",    "?",         "?",        "?"                 },
        {  "?",            "PTD13", "SPI2_SOUT", "?",          "SDHC0_D5",    "?",         "?",        "?"                 },
        {  "?",            "PTD14", "SPI2_SIN",  "?",          "SDHC0_D6",    "?",         "?",        "?"                 },
        {  "?",            "PTD15", "SPI2_PCS1", "?",          "SDHC0_D7",    "?",         "?",        "?"                 },
        {  "?",            "?",     "?",         "?",          "?",           "?",         "?",        "?"                 },
        {  "?",            "?",     "?",         "?",          "?",           "?",         "?",        "?"                 },
        {  "?",            "?",     "?",         "?",          "?",           "?",         "?",        "?"                 },
        {  "?",            "?",     "?",         "?",          "?",           "?",         "?",        "?"                 },
...
static const char *cPer[PORTS_AVAILABLE][PORT_WIDTH][8] = {              // 144 pin LQFP/MAPBGA
    ...
    },
    {
        ...
        {  "?",            "?",     "?",         "?",          "?",           "?",         "?",        "?"                 },
        {  "?",            "?",     "?",         "?",          "?",           "?",         "?",        "?"                 },
        {  "?",            "PTD10", "?",         "UART5_RTS_b","?",           "FB_AD9",    "?",        "?"                 },
        {  "?",            "PTD11", "SPI2_PCS0", "UART5_CTS_b","SDHC0_CLKIN", "FB_AD8",    "?",        "?"                 },
        {  "?",            "PTD12", "SPI2_SCK",  "?",          "SDHC0_D4",    "FB_AD7",    "?",        "?"                 },
        {  "?",            "PTD13", "SPI2_SOUT", "?",          "SDHC0_D5",    "FB_AD6",    "?",        "?"                 },
        {  "?",            "PTD14", "SPI2_SIN",  "?",          "SDHC0_D6",    "FB_AD5",    "?",        "?"                 },
        {  "?",            "PTD15", "SPI2_PCS1", "?",          "SDHC0_D7",    "FB_RW_b",   "?",        "?"                 },
        {  "?",            "?",     "?",         "?",          "?",           "?",         "?",        "?"                 },
        {  "?",            "?",     "?",         "?",          "?",           "?",         "?",        "?"                 },
        {  "?",            "?",     "?",         "?",          "?",           "?",         "?",        "?"                 },
        {  "?",            "?",     "?",         "?",          "?",           "?",         "?",        "?"                 },
    ...
    },
    {
        ...
        {  "D",            "PTE26", "?",         "UART4_CTS_b","?",           "FB_AD22",   "RTC_CLKOUT","?"                },
        {  "D",            "PTE27", "?",         "UART4_RTS_b","?",           "FB_AD21",   "?",        "?"                 },
        {  "D",            "PTE28", "?",         "?",          "?",           "FB_AD20",   "?",        "?"                 },
        {  "?",            "?",     "?",         "?",          "?",           "?",         "?",        "?"                 },
        {  "?",            "?",     "?",         "?",          "?",           "?",         "?",        "?"                 },
        {  "?",            "?",     "?",         "?",          "?",           "?",         "?",        "?"                 }
