...
/* =================================================================== */
    ...
    #if defined KINETIS_KL || defined KINETIS_KM || defined LPITS_AVAILABLE
...
//
  ...
  //#endif
    ...
    #if defined KINETIS_KL || defined KINETIS_KM ||defined LPITS_AVAILABLE // {3} KL, and LPIT, devices have a single interrupt from the PIT channels
